...
#         ]
#     )
#     assert(required_zero(arr) == 1), "Invalid number of required zeros"
#     arr = np.array(
#         [
#             [10, -1],
#             [ 1, 20],
...
#         ]
#     )
#     assert(required_zero(arr) == 2), "Invalid number of required zeros"
#     arr = np.array(
#         [
#             [1],
#         ]
#     )
    # assert(required_zero(arr) == 0), "Invalid number of required zeros"
